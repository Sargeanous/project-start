...
export const assets: Asset[] = [
  {
    ...
    x: 57,
    y: 36,
    // Corniche Road lay-by beside Nation Towers. Keep map pins on a
    // credible road edge rather than using approximate waterfront points.
    lat: 24.4668951,
    lng: 54.3335799,
  ...
  },
  {
    ...
    installed: "Aug 2022",
    address: "Mussafah Bridge southern approach, Rabdan, Abu Dhabi",
    uptime: "98.61%",
    cacheDays: "3 days",
    tempC: "57°C",
    otaRing: "Ring 1",
  ...
  },
  {
    ...
    installed: "Nov 2021",
    address: "Al Ain Truck Road, Industrial City 3 approach, Al Ain",
    uptime: "92.40%",
    cacheDays: "0 days",
    tempC: "n/a (offline)",
    otaRing: "Ring 1",
  },
  {
    ...
    installed: "Jun 2023",
    address: "Abu Dhabi Mall main entrance, Al Zahiyah, Abu Dhabi",
    uptime: "96.12%",
    cacheDays: "6 days",
    tempC: "35°C",
    otaRing: "Ring 2",
  ...
  {
    id: "AD-CRN-003",
    name: "Corniche Beach Gateway",
    type: "Digital pylon",
    zone: "Abu Dhabi City",
    status: "Live",
    pop: "99.82%",
    brightness: "16,400 cd",
    controller: "Edge-Orin-03",
    network: "5G primary / fiber backup",
    x: 52,
    y: 30,
    lat: 24.4725,
    lng: 54.34,
    audience: "268k weekly",
    nextSlot: "Louvre summer exhibition",
    feedId: "vf-2",
    size: "8.0 m x 4.0 m (32 m²)",
    resolution: "2560 x 1280 px",
    installed: "Feb 2024",
    address: "Corniche Beach west gate, Corniche Road, Abu Dhabi",
    uptime: "99.82%",
    cacheDays: "7 days",
    tempC: "40°C",
    otaRing: "Ring 2",
  ...
  {
    id: "AD-ARP-006",
    name: "Airport Road Gantry East",
    type: "Highway gantry",
    zone: "Abu Dhabi City",
    status: "Live",
    pop: "99.71%",
    brightness: "19,000 cd",
    controller: "Edge-Orin-06",
    network: "Fiber primary / 5G backup",
    x: 62,
    y: 40,
    lat: 24.4177935,
    lng: 54.447876,
    audience: "356k weekly",
    nextSlot: "Arrival retail",
    feedId: "vf-1",
    size: "12.0 m x 3.5 m (42 m²)",
    resolution: "3456 x 1008 px",
    installed: "Sep 2023",
    address: "Airport Road eastbound gantry, near Zayed Sports City",
    uptime: "99.71%",
    cacheDays: "7 days",
    tempC: "45°C",
    otaRing: "Ring 1",
  ...
  {
    id: "AD-DWT-004",
    name: "Hamdan Street Digital",
    type: "Street unipole",
    zone: "Downtown",
    status: "Live",
    pop: "99.65%",
    brightness: "12,800 cd",
    controller: "Edge-AX-04",
    network: "Fiber primary",
    x: 46,
    y: 47,
    lat: 24.4890,
    lng: 54.3620,
    audience: "231k weekly",
    nextSlot: "5G family bundle",
    feedId: "vf-4",
    size: "6.0 m x 3.0 m (18 m²)",
    resolution: "2160 x 1080 px",
    installed: "Apr 2024",
    address: "Hamdan Bin Mohammed Street, Al Danah, Abu Dhabi",
    uptime: "99.65%",
    cacheDays: "6 days",
    tempC: "39°C",
    otaRing: "Ring 3",
  },
  {
    ...
    status: "Warning",
    pop: "97.34%",
    brightness: "10,900 cd",
    controller: "Edge-AX-21",
    network: "Fiber primary",
    x: 49,
    y: 49,
    lat: 24.4873912,
    lng: 54.3573235,
    audience: "187k weekly",
    nextSlot: "Weekend mall offer",
    feedId: "vf-5",
    size: "5.0 m x 2.8 m (14 m²)",
    resolution: "1920 x 1080 px",
    installed: "Oct 2022",
    address: "World Trade Center Souk facade, Khalifa Street, Abu Dhabi",
    uptime: "97.34%",
    cacheDays: "4 days",
    tempC: "51°C",
    otaRing: "Ring 2",
  ...
  {
    id: "AD-YAS-005",
    name: "Yas Mall North Face",
    type: "Mall facade LED",
    zone: "Yas Island",
    status: "Live",
    pop: "99.90%",
    brightness: "14,600 cd",
    controller: "Edge-Nano-05",
    network: "5G primary",
    x: 79,
    y: 26,
    lat: 24.4887,
    lng: 54.6079,
    audience: "294k weekly",
    nextSlot: "Yas summer promotion",
    feedId: "vf-2",
    size: "9.0 m x 5.0 m (45 m²)",
    resolution: "2880 x 1600 px",
    installed: "Dec 2023",
    address: "Yas Mall north entrance, Yas Island",
    uptime: "99.90%",
    cacheDays: "7 days",
    tempC: "37°C",
    otaRing: "Ring 3",
  ...
  {
    id: "AD-YAS-018",
    name: "Ferrari World Approach",
    type: "Highway billboard",
    zone: "Yas Island",
    status: "Live",
    pop: "99.58%",
    brightness: "18,200 cd",
    controller: "Edge-Orin-18",
    network: "5G primary / satellite backup",
    x: 82,
    y: 30,
    lat: 24.4838,
    lng: 54.6039,
    audience: "342k weekly",
    nextSlot: "Eid family staycation",
    feedId: "vf-1",
    size: "14.0 m x 4.0 m (56 m²)",
    resolution: "3840 x 1096 px",
    installed: "May 2023",
    address: "Yas Leisure Drive approach to Ferrari World, Yas Island",
    uptime: "99.58%",
    cacheDays: "7 days",
    tempC: "44°C",
    otaRing: "Ring 1",
  ...
  {
    id: "AD-MSF-007",
    name: "Mussafah Gate Pylon",
    type: "Digital pylon",
    zone: "Industrial Zone",
    status: "Warning",
    pop: "98.02%",
    brightness: "15,700 cd",
    controller: "Edge-AX-07",
    network: "Fiber primary",
    x: 64,
    y: 63,
    lat: 24.3672,
    lng: 54.4870,
    audience: "176k weekly",
    nextSlot: "Industrial safety notice",
    feedId: "vf-3",
    size: "7.0 m x 3.5 m (24.5 m²)",
    resolution: "2240 x 1120 px",
    installed: "Jul 2022",
    address: "Mussafah industrial gate, route E30, Abu Dhabi",
    uptime: "98.02%",
    cacheDays: "5 days",
    tempC: "55°C",
    otaRing: "Ring 1",
  ...
  {
    id: "AD-ALN-002",
    name: "Al Ain Clock Tower Gateway",
    type: "Digital pylon",
    zone: "Al Ain",
    status: "Live",
    pop: "99.44%",
    brightness: "13,900 cd",
    controller: "Edge-Orin-02",
    network: "Fiber primary / 5G backup",
    x: 30,
    y: 68,
    lat: 24.2210755,
    lng: 55.7579935,
    audience: "154k weekly",
    nextSlot: "National reading month",
    feedId: "vf-4",
    size: "6.5 m x 3.2 m (20.8 m²)",
    resolution: "2160 x 1064 px",
    installed: "Mar 2024",
    address: "Clock Tower roundabout, central district, Al Ain",
    uptime: "99.44%",
    cacheDays: "6 days",
    tempC: "43°C",
    otaRing: "Ring 2",
  ...
  {
    id: "AD-ALN-013",
    name: "Jimi Mall Corridor",
    type: "Mall facade LED",
    zone: "Al Ain",
    status: "Live",
    pop: "99.51%",
    brightness: "11,300 cd",
    controller: "Edge-Nano-13",
    network: "5G primary",
    x: 27,
    y: 65,
    lat: 24.2441977,
    lng: 55.7267267,
    audience: "132k weekly",
    nextSlot: "Weekend mall offer",
    feedId: "vf-5",
    size: "5.5 m x 3.0 m (16.5 m²)",
    resolution: "1920 x 1044 px",
    installed: "Jan 2025",
    address: "Al Jimi Mall east corridor, Al Ain",
    uptime: "99.51%",
    cacheDays: "7 days",
    tempC: "41°C",
    otaRing: "Ring 3",
...
export const assetAllocations: AssetAllocation[] = [
  ...
  },
  {
    assetId: "AD-CRN-003",
    status: "Allocated",
    operator: "DCT Abu Dhabi",
    contractRef: "CTR-2026-014",
    model: "Fixed slots",
    permittedCategories: "Culture, tourism, civic",
    effectiveDate: "2026-02-01",
    expiryDate: "2027-01-31",
    annualValueAed: 960000,
    rateCardWeekAed: 26000,
    shareOfVoice: "35% SOV, daytime fixed slots",
    publicSplitTarget: "35% public / 65% commercial",
    publicSplitActual: "37% public / 63% commercial",
    revenueToDateAed: 410000,
    note: "Cultural-district anchor buy; museum season uplift clause active.",
  },
  {
    assetId: "AD-ARP-006",
    status: "Allocated",
    operator: "Abu Dhabi Duty Free",
    contractRef: "CTR-2026-031",
    model: "Fixed slots",
    permittedCategories: "Retail, travel, tourism",
    effectiveDate: "2026-04-01",
    expiryDate: "2027-03-31",
    annualValueAed: 1220000,
    rateCardWeekAed: 31500,
    shareOfVoice: "45% SOV, arrival-window fixed slots",
    publicSplitTarget: "30% public / 70% commercial",
    publicSplitActual: "30% public / 70% commercial",
    revenueToDateAed: 305000,
    note: "Arrival retail follow-on from HB-9006 award.",
  },
  {
    assetId: "AD-DWT-004",
    status: "In bidding",
    lotId: "LOT-4408",
    rateCardWeekAed: 18500,
    publicSplitTarget: "30% public / 70% commercial",
    note: "Bundled into the downtown retail weekend lot; award pending.",
  },
  {
    assetId: "AD-DWT-021",
    status: "Available",
    rateCardWeekAed: 15000,
    publicSplitTarget: "30% public / 70% commercial",
    note: "Brightness warning under review; sellable at reduced evening rate.",
  },
  {
    assetId: "AD-YAS-005",
    status: "Allocated",
    operator: "Aldar Yas Mall",
    contractRef: "CTR-2025-118",
    model: "Variable share-of-voice",
    permittedCategories: "Retail, leisure, events",
    effectiveDate: "2025-12-01",
    expiryDate: "2026-11-30",
    annualValueAed: 840000,
    rateCardWeekAed: 19800,
    shareOfVoice: "30% SOV, mall trading hours",
    publicSplitTarget: "25% public / 75% commercial",
    publicSplitActual: "26% public / 74% commercial",
    revenueToDateAed: 495000,
    note: "Mall anchor tenant package; event-day boost windows reserved.",
  },
  {
    assetId: "AD-YAS-018",
    status: "In bidding",
    ...
    effectiveDate: "2025-09-01",
    expiryDate: "2026-08-30",
    annualValueAed: 710000,
    rateCardWeekAed: 17200,
    shareOfVoice: "25% SOV, flexible windows",
    publicSplitTarget: "35% public / 65% commercial",
    publicSplitActual: "34% public / 66% commercial",
    revenueToDateAed: 388000,
    note: "Second Yas asset in the summer flight lot; renewal tracks LOT-4402 outcome.",
  },
  {
    assetId: "AD-MSF-007",
    status: "Available",
    rateCardWeekAed: 9800,
    publicSplitTarget: "45% public / 55% commercial",
    note: "Industrial corridor inventory; safety-notice rotation takes precedence.",
  },
  {
    assetId: "AD-ALN-002",
    status: "Allocated",
    operator: "ADMO",
    contractRef: "CIV-2026-007",
    model: "Fixed slots",
    permittedCategories: "Civic, education, health",
    effectiveDate: "2026-01-01",
    expiryDate: "2026-12-31",
    annualValueAed: 0,
    rateCardWeekAed: 8600,
    shareOfVoice: "60% SOV, civic programming",
    publicSplitTarget: "60% public / 40% commercial",
    publicSplitActual: "62% public / 38% commercial",
    revenueToDateAed: 0,
    note: "Civic reserve asset; commercial windows sold ad hoc around programming.",
  },
  {
    assetId: "AD-ALN-013",
    status: "Available",
    rateCardWeekAed: 7900,
    publicSplitTarget: "40% public / 60% commercial",
    note: "New install; first commercial availability window opens Aug 2026.",
  },
];
