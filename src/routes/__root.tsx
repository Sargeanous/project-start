...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ADMO Unified DOOH Platform" },
      ...
      { name: "twitter:title", content: "ADMO Unified DOOH Platform" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;650;700&family=Noto+Sans+Arabic:wght@400;500;600;700&display=swap" },
